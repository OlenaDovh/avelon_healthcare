"""Модуль `reviews/views/public.py` застосунку `reviews`.
...
def review_list_view(request: HttpRequest) -> HttpResponse:
    """Виконує прикладну логіку функції `review_list_view` у відповідному модулі проєкту.
...
def review_create_view(request: HttpRequest, appointment_id: int) -> HttpResponse:
    """Виконує прикладну логіку функції `review_create_view` у відповідному модулі проєкту.
