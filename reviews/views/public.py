...
Returns:
    ...
    return render(request, 'avelon_healthcare/reviews/pages/review_list.html', {'page_obj': page_obj})
...
Returns:
    ...
    return render(request, 'avelon_healthcare/reviews/pages/review_form.html', {'form': form, 'appointment': appointment})
