"""Модуль `appointments/forms/support.py` застосунку `appointments`.
...
class SupportAppointmentCreateForm(AppointmentCreateForm):
    """Клас `SupportAppointmentCreateForm` інкапсулює повʼязану логіку проєкту.

    Базові класи: `AppointmentCreateForm`.
    ...
    class Meta(AppointmentCreateForm.Meta):
        ...
        Базові класи: `AppointmentCreateForm.Meta`.
        Використовується для опису доменної сутності, форми, адміністративної конфігурації, сервісу або представлення залежно від місця використання.
        """
        fields = (
            "user",
