"""Модуль `appointments/forms/create.py` застосунку `appointments`.
...
class AppointmentCreateForm(forms.ModelForm):
    """Клас `AppointmentCreateForm` інкапсулює повʼязану логіку проєкту.
...
class GuestAppointmentCreateForm(AppointmentCreateForm):
    """Клас `GuestAppointmentCreateForm` інкапсулює повʼязану логіку проєкту.
