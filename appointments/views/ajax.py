...
Returns:
    ...
    if exclude_appointment_id:
        try:
            ...
            exclude_id = None
    slots = get_available_slots_for_doctor_on_date(doctor, direction, selected_date, exclude_appointment_id=exclude_id)
...
Returns:
    ...
    doctors = Doctor.objects.filter(directions__id=direction_id).distinct().order_by('last_name', 'first_name')
    return JsonResponse({'doctors': [{'id': doctor.id, 'full_name': doctor.full_name} for doctor in doctors]})
...
Returns:
    ...
    if exclude_appointment_id:
        try:
            ...
            exclude_id = None
    result = get_available_dates_for_doctor_direction(doctor, direction, exclude_appointment_id=exclude_id)
