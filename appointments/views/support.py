"""Модуль `appointments/views/support.py` застосунку `appointments`.
...
def support_appointment_list_view(request: HttpRequest) -> HttpResponse:
    """Виконує прикладну логіку функції `support_appointment_list_view` у відповідному модулі проєкту.
...
def support_appointment_create_view(request: HttpRequest) -> HttpResponse:
    """Виконує прикладну логіку функції `support_appointment_create_view` у відповідному модулі проєкту.
...
def support_appointment_update_view(request: HttpRequest, appointment_id: int) -> HttpResponse:
    """Виконує прикладну логіку функції `support_appointment_update_view` у відповідному модулі проєкту.
