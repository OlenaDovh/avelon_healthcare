...
Відповідає за поведінку, описану в цьому компоненті застосунку."""
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True,
                             related_name='support_chat_sessions', verbose_name='Користувач')
    ...
    operator = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True,
                                 related_name='assigned_support_chat_sessions', verbose_name='Оператор')
    status = models.CharField(max_length=20, choices=SupportChatStatus.choices, default=SupportChatStatus.WAITING,
                              verbose_name='Статус')
