"""Модуль `accounts/views/profile.py` застосунку `accounts`.
...
def profile_view(request: HttpRequest) -> HttpResponse:
    """Виконує прикладну логіку функції `profile_view` у відповідному модулі проєкту.
...
def profile_update_view(request: HttpRequest) -> HttpResponse:
    """Виконує прикладну логіку функції `profile_update_view` у відповідному модулі проєкту.
...
def staff_dashboard_view(request: HttpRequest) -> HttpResponse:
    """Виконує прикладну логіку функції `staff_dashboard_view` у відповідному модулі проєкту.
