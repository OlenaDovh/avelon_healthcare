"""Модуль `accounts/models.py` застосунку `accounts`.
...
class PreferredContactChannel(models.TextChoices):
    """Клас `PreferredContactChannel` інкапсулює повʼязану логіку проєкту.
...
class User(AbstractUser):
    ...
    def full_name(self) -> str:
        """Виконує прикладну логіку функції `full_name` у відповідному модулі проєкту.
