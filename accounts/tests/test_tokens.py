...
def test_email_verification_token_generated_for_user(verification_token):
    assert verification_token
    assert isinstance(verification_token, str)

@pytest.mark.django_db
def test_email_verification_token_valid_for_same_user(user, verification_token):
    assert email_verification_token.check_token(user, verification_token) is True

@pytest.mark.django_db
def test_token_invalid_for_other_user(user, user_factory, verification_token):
