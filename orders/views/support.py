"""Модуль `orders/views/support.py` застосунку `orders`.
...
def support_order_list_view(request: HttpRequest) -> HttpResponse:
    """Виконує прикладну логіку функції `support_order_list_view` у відповідному модулі проєкту.
...
def support_order_create_view(request: HttpRequest) -> HttpResponse:
    """Виконує прикладну логіку функції `support_order_create_view` у відповідному модулі проєкту.
...
def support_order_update_view(request: HttpRequest, order_id: int) -> HttpResponse:
    """Виконує прикладну логіку функції `support_order_update_view` у відповідному модулі проєкту.
