"""Модуль `orders/views/patient.py` застосунку `orders`.
...
def order_list_view(request: HttpRequest) -> HttpResponse:
    """Виконує прикладну логіку функції `order_list_view` у відповідному модулі проєкту.
...
def order_detail_view(request: HttpRequest, order_id: int) -> HttpResponse:
    """Виконує прикладну логіку функції `order_detail_view` у відповідному модулі проєкту.
...
def order_pay_view(request: HttpRequest, order_id: int) -> HttpResponse:
    """Виконує прикладну логіку функції `order_pay_view` у відповідному модулі проєкту.
...
def order_cancel_view(request: HttpRequest, order_id: int) -> HttpResponse:
    """Виконує прикладну логіку функції `order_cancel_view` у відповідному модулі проєкту.
...
def order_invoice_view(request: HttpRequest, order_id: int) -> HttpResponse:
    """Виконує прикладну логіку функції `order_invoice_view` у відповідному модулі проєкту.
