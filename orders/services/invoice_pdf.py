"""Модуль `orders/services/invoice_pdf.py` застосунку `orders`.
...
def _register_fonts() -> None:
    """Виконує прикладну логіку функції `_register_fonts` у відповідному модулі проєкту.
...
def generate_order_invoice_pdf(order: Order) -> bytes:
    """Виконує прикладну логіку функції `generate_order_invoice_pdf` у відповідному модулі проєкту.

    Параметри:
        order: Значення типу `Order`, яке передається для виконання логіки функції.

    Повертає:
        bytes: Результат роботи функції або обʼєкт, сформований під час виконання.
    """
    _register_fonts()
...
def build_order_invoice_response(order: Order) -> HttpResponse:
    """Виконує прикладну логіку функції `build_order_invoice_response` у відповідному модулі проєкту.
