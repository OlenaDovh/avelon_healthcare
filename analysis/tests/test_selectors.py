"""Модуль `analysis/tests/test_selectors.py` застосунку `analysis`.
...
def test_active_analyses_queryset_returns_only_active(analysis_factory: Any) -> None:
    """Виконує прикладну логіку функції `test_active_analyses_queryset_returns_only_active` у відповідному модулі проєкту.
...
def test_filtered_analyses_queryset_filters_by_what_to_check(analysis_factory: Any) -> None:
    """Виконує прикладну логіку функції `test_filtered_analyses_queryset_filters_by_what_to_check` у відповідному модулі проєкту.
...
def test_filtered_analyses_queryset_filters_by_disease(analysis_factory: Any) -> None:
    """Виконує прикладну логіку функції `test_filtered_analyses_queryset_filters_by_disease` у відповідному модулі проєкту.
...
def test_filtered_analyses_queryset_filters_by_for_whom(analysis_factory: Any) -> None:
    """Виконує прикладну логіку функції `test_filtered_analyses_queryset_filters_by_for_whom` у відповідному модулі проєкту.
...
def test_filtered_analyses_queryset_filters_by_biomaterial(analysis_factory: Any) -> None:
    """Виконує прикладну логіку функції `test_filtered_analyses_queryset_filters_by_biomaterial` у відповідному модулі проєкту.
...
def test_analysis_filter_values_returns_distinct_values(analysis_factory: Any) -> None:
    """Виконує прикладну логіку функції `test_analysis_filter_values_returns_distinct_values` у відповідному модулі проєкту.
