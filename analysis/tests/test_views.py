"""Модуль `analysis/tests/test_views.py` застосунку `analysis`.
...
def create_head_manager(user: Any) -> Any:
    """Виконує прикладну логіку функції `create_head_manager` у відповідному модулі проєкту.
...
def test_analysis_list_view_opens(client: Any, analysis_factory: Any) -> None:
    """Виконує прикладну логіку функції `test_analysis_list_view_opens` у відповідному модулі проєкту.

    Параметри:
        client: Значення типу `Any`, яке передається для виконання логіки функції.
        analysis_factory: Значення типу `Any`, яке передається для виконання логіки функції.
...
def test_add_to_cart_view_redirects_and_adds_item(client: Any, analysis: Any) -> None:
    """Виконує прикладну логіку функції `test_add_to_cart_view_redirects_and_adds_item` у відповідному модулі проєкту.
...
def test_remove_from_cart_view_redirects_and_removes_item(client: Any, analysis: Any) -> None:
    """Виконує прикладну логіку функції `test_remove_from_cart_view_redirects_and_removes_item` у відповідному модулі проєкту.
...
def test_cart_detail_view_opens(client: Any, analysis: Any) -> None:
    """Виконує прикладну логіку функції `test_cart_detail_view_opens` у відповідному модулі проєкту.
...
def test_head_manager_analysis_list_view_opens_for_head_manager(client: Any, user: Any, analysis_factory: Any) -> None:
    """Виконує прикладну логіку функції `test_head_manager_analysis_list_view_opens_for_head_manager` у відповідному модулі проєкту.
...
def test_head_manager_analysis_create_view_get_opens_for_head_manager(client: Any, user: Any) -> None:
    """Виконує прикладну логіку функції `test_head_manager_analysis_create_view_get_opens_for_head_manager` у відповідному модулі проєкту.
...
def test_head_manager_analysis_create_view_post_creates_analysis(client: Any, user: Any) -> None:
    """Виконує прикладну логіку функції `test_head_manager_analysis_create_view_post_creates_analysis` у відповідному модулі проєкту.
    ...
    response = client.post(
        reverse("analysis:head_manager_analysis_create"),
        {
            "name": "Новий аналіз",
...
def test_head_manager_analysis_update_view_get_opens_for_head_manager(client: Any, user: Any, analysis: Any) -> None:
    """Виконує прикладну логіку функції `test_head_manager_analysis_update_view_get_opens_for_head_manager` у відповідному модулі проєкту.
...
def test_head_manager_analysis_update_view_post_updates_analysis(client: Any, user: Any, analysis: Any) -> None:
    """Виконує прикладну логіку функції `test_head_manager_analysis_update_view_post_updates_analysis` у відповідному модулі проєкту.
    ...
    response = client.post(
        reverse("analysis:head_manager_analysis_update", args=[analysis.pk]),
        {
            "name": "Оновлений аналіз",
