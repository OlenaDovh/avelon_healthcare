"""Модуль `analysis/views/public.py` застосунку `analysis`.
...
def analysis_list_view(request: HttpRequest) -> HttpResponse:
    """Виконує прикладну логіку функції `analysis_list_view` у відповідному модулі проєкту.
...
def add_to_cart_view(request: HttpRequest, analysis_id: int) -> HttpResponse:
    """Виконує прикладну логіку функції `add_to_cart_view` у відповідному модулі проєкту.
...
def remove_from_cart_view(request: HttpRequest, analysis_id: int) -> HttpResponse:
    """Виконує прикладну логіку функції `remove_from_cart_view` у відповідному модулі проєкту.
...
def cart_detail_view(request: HttpRequest) -> HttpResponse:
    """Виконує прикладну логіку функції `cart_detail_view` у відповідному модулі проєкту.
