...
Args:
    what_to_check: Вхідний параметр `what_to_check`.
    disease: Вхідний параметр `disease`.
    for_whom: Вхідний параметр `for_whom`.
    biomaterial: Вхідний параметр `biomaterial`.
