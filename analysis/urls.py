"""Модуль `analysis/urls.py` застосунку `analysis`.
...
from analysis.views import (
    ...
    head_manager_analysis_update_view,
...
urlpatterns = [
    ...
    path(
        "head-manager/analysis/",
        head_manager_analysis_list_view,
        name="head_manager_analysis_list",
    ),
    path(
        "head-manager/analysis/create/",
        head_manager_analysis_create_view,
        name="head_manager_analysis_create",
    ),
    path(
        "head-manager/analysis/<int:pk>/update/",
        head_manager_analysis_update_view,
        name="head_manager_analysis_update",
    ),
]
