...
HOROSCOPE_THEMES = ['енергія дня', 'внутрішній баланс', 'турбота про себе', 'спокій і відновлення', 'м’яка продуктивність', 'емоційний комфорт', 'гармонія і стабільність']
...
Returns:
    ...
    result = {'date': today_str, 'text': text, 'theme': theme}
