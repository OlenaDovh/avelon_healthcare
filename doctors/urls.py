...
urlpatterns = [
    ...
    path("head-manager/doctors/create/",
         head_manager_doctor_create_view,
         name="head_manager_doctor_create"
         ),
    path(
    ...
    path("head-manager/directions/",
         head_manager_direction_list_view,
         name="head_manager_direction_list"
         ),
    path(
    ...
    path("head-manager/schedules/",
         head_manager_schedule_list_view,
         name="head_manager_schedule_list"
         ),
    path(
