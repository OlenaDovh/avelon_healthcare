...
Returns:
    ...
    if request.method == 'POST':
        ...
        form = DoctorForm()
    return render(request, 'avelon_healthcare/doctors/pages/head_manager_doctor_form.html', {'form': form})
...
Returns:
    ...
    return render(request, 'avelon_healthcare/doctors/pages/head_manager_doctor_form.html', {'form': form, 'doctor': doctor})
...
Returns:
    ...
    if request.method == 'POST':
        ...
        form = DirectionForm()
    return render(request, 'avelon_healthcare/doctors/pages/head_manager_direction_form.html', {'form': form})
...
Returns:
    ...
    return render(request, 'avelon_healthcare/doctors/pages/head_manager_direction_form.html', {'form': form, 'direction': direction})
...
Returns:
    ...
    return render(request, 'avelon_healthcare/doctors/pages/head_manager_schedule_form.html', {'form': form, 'formset': formset})
...
Returns:
    ...
    return render(request, 'avelon_healthcare/doctors/pages/head_manager_schedule_form.html', {'form': form, 'formset': formset, 'schedule': schedule})
